...
const defaultEvents = [
    ...
    },
    {
        ...
        outputs: [
            {
                id: 'e_mouse_button_out_which',
                type: SOCKET_TYPE.STRING,
            },
            {
                id: 'e_mouse_button_out_x',
                type: SOCKET_TYPE.NUMBER,
            },
            {
                id: 'e_mouse_button_out_y',
                type: SOCKET_TYPE.NUMBER,
            },
            {
                id: 'e_mouse_button_out_object',
                type: SOCKET_TYPE.OBJECT,
            },
        ]
    },
    {
        ...
        outputs: [
            {
                id: 'e_mouse_move_out_x',
                type: SOCKET_TYPE.NUMBER,
            },
            {
                id: 'e_mouse_move_out_y',
                type: SOCKET_TYPE.NUMBER,
            },
        ],
    },
    ...
    },
    {
        ...
        outputs: [
            {
                id: 'e_message_out_name',
                type: SOCKET_TYPE.STRING,
            },
            {
                id: 'e_message_out_data',
                type: SOCKET_TYPE.ANY,
            },
        ],
    },
];
